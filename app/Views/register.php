          ...
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" action="<?= base_url(); ?>/auth/saveRegister" method="post">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user <?= ($validation->hasError('nama_lengkap')) ? 'is-invalid' : ''; ?>" name="nama_lengkap" placeholder="Nama Lengkap" value="<?= old('nama_lengkap'); ?>">
                  <div class="invalid-feedback">
