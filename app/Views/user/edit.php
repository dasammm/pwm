                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control <?= ($validation->hasError('role')) ? 'is-invalid' : ''; ?>" id="role" name="role">
                        ...
                        <option value="client" <?= ((old('role')) ? old('role') : $user['role']) == 'client' ? 'selected' : ''; ?>>Client</option>
                        <option value="customer" <?= ((old('role')) ? old('role') : $user['role']) == 'customer' ? 'selected' : ''; ?>>Customer</option>
                      </select>
                      <div class="invalid-feedback">
